...
CHACHA20_POLY1305_WARMUP_ITER=200
...
run_eval: build_eval
	...
	./eval_ed25519  $(ED25519_NUM_ITER) $(ED25519_WARMUP_ITER) $(ED25519_MSG_LEN) \
		> $(EVAL_DIR)/libsodium-ed25519.log 2>&1
	./eval_chacha20_poly1305_encrypt $(CHACHA20_POLY1305_NUM_ITER) $(CHACHA20_POLY1305_WARMUP_ITER) $(CHACHA20_POLY1305_MSG_LEN) $(CHACHA20_POLY1305_AD_LEN) \
		> $(EVAL_DIR)/libsodium-chacha20-poly1305-encrypt.log 2>&1
	./eval_chacha20_poly1305_decrypt $(CHACHA20_POLY1305_NUM_ITER) $(CHACHA20_POLY1305_WARMUP_ITER) $(CHACHA20_POLY1305_MSG_LEN) $(CHACHA20_POLY1305_AD_LEN) \
		> $(EVAL_DIR)/libsodium-chacha20-poly1305-decrypt.log 2>&1
	./eval_aesni256gcm_encrypt  $(AESNI256GCM_NUM_ITER) $(AESNI256GCM_WARMUP_ITER) $(AESNI256GCM_MSG_LEN) $(AESNI256GCM_AD_LEN) \
		> $(EVAL_DIR)/libsodium-aesni256gcm-encrypt.log 2>&1
	./eval_aesni256gcm_decrypt  $(AESNI256GCM_NUM_ITER) $(AESNI256GCM_WARMUP_ITER) $(AESNI256GCM_MSG_LEN) $(AESNI256GCM_AD_LEN) \
		> $(EVAL_DIR)/libsodium-aesni256gcm-decrypt.log 2>&1
	./eval_argon2id  $(ARGON2ID_NUM_ITER) $(ARGON2ID_WARMUP_ITER) $(ARGON2ID_PASSWD_LEN) $(ARGON2ID_OUT_LEN) \
